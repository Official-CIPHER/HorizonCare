...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHanlder} className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded text-[#5E5E5E] text-sm shadow-lg'>
        ...
        <button className='bg-green-500 text-white w-full py-2 rounded-md text-base'>Login</button>
      {
        state === 'Admin' 
